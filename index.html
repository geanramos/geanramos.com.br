...
<html lang="pt-br">
	<head>
		...
		<meta property="og:title" content="U1M Busca">
		...
		<meta name="twitter:title" content="U1M Busca">
        ...
        <script async src="https://cse.google.com/cse.js?cx=partner-pub-1416126749136213:1015486489"></script>
	...
	<body>
		<h1 id="title" class="font-zero">U1M Busca</h1>
		<div id="home" class="container uol">
			<section class="main">
				<h1 class="font-zero">Encontre o que você procura</h1>
				<img style="height: 60px;" src="https://i1.wp.com/cdn.jsdelivr.net/gh/geanramos/files/logo/7.png?resize=250,64" alt="Logo do U1M Busca" title="Logo do U1M Busca" class="logo">
                
				<div class="search">
					<form action="https://www.google.com.br/search" method="get" id="search-form" accept-charset="utf-8">
						<div class="box">
